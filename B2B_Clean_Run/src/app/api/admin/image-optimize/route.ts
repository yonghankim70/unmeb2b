  ...
  try {
    ...
    const child = spawn(process.execPath, ['scripts/warm-image-cache.js'], {
      ...
      env: {
        ...
        B2B_MAIN_IMAGE_WIDTHS: process.env.B2B_MAIN_IMAGE_WIDTHS || '480,720',
        B2B_DETAIL_IMAGE_WIDTHS: process.env.B2B_DETAIL_IMAGE_WIDTHS || '1200,1600',
        B2B_MAIN_IMAGE_QUALITY: process.env.B2B_MAIN_IMAGE_QUALITY || '88',
        B2B_DETAIL_IMAGE_QUALITY: process.env.B2B_DETAIL_IMAGE_QUALITY || '90',
      },
